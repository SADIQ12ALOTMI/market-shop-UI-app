...
class SplashLogoHome extends StatefulWidget {
  @override
  _SplashLogoHomeState createState() => _SplashLogoHomeState();
}

class _SplashLogoHomeState extends State<SplashLogoHome> {
  @override
  void initState() {
    super.initState();
